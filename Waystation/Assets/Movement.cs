...
public class Movement : MonoBehaviour {
	...
	public float FRAMERATE = 0.2f; //Animation speed as a float.
	...
	public float timer = FRAMERATE; //This timer is necessary to synch the animation with Unity time.
	...
	void Start(){
		player = Resources.LoadAll<Sprite>(/*Sprite Sheet Path Goes Here*/); 
